/* 
Midterm Work in Progress 
By Francky Duperval

Requirements: 
-Expanded Short Study: Choose one of your past short studies to expand upon, 
- creating three (or more) distinct state changes for the user to experience. 
- For example, this may be a simple game with a pre-game menu, game experience, and game-over state. Or a simple game with three different levels. 
- Or a creative visualization that has at least three distinct visual experiences.
